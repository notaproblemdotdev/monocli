"""Integration registry for monocle.
...
if t.TYPE_CHECKING:
    from monocle.sources.base import SetupCapableSource
...
def _register_all_integrations() -> None:
    ...
    from monocle.sources.azuredevops import AzureDevOpsAPISetupSource
    from monocle.sources.github import GitHubCLISetupSource
    from monocle.sources.gitlab import GitLabCLISetupSource
    from monocle.sources.jira import JiraCLISetupSource
    from monocle.sources.todoist import TodoistAPISetupSource
