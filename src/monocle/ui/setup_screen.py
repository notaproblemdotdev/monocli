...
from monocle.sources.base import AdapterStatus
from monocle.sources.integrations import get_all_integrations

if TYPE_CHECKING:
    from monocle.sources.base import SetupCapableSource
    from monocle.sources.integrations import IntegrationMeta
...
class SetupActionDialog(Screen):
    ...
    async def on_mount(self) -> None:
        from monocle.sources.integrations import get_integration
    ...
    async def _run_external_process(self):
        from monocle.sources.base import SetupResult
