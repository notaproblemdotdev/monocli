...
from monocle.ui.sorting import SORT_INDICATOR_NONE
from monocle.ui.sorting import SortMethod
from monocle.ui.sorting import SortState
from monocle.ui.sorting import get_sort_indicator
...
class CodeReviewSubSection(BaseSection):
    ...
    def _perform_sort(self) -> None:
        ...
        from monocle.ui.sorting import get_code_review_sort_key
...
class PieceOfWorkSection(BaseSection):
    ...
    def _perform_sort(self) -> None:
        ...
        from monocle.ui.sorting import get_work_item_sort_key
